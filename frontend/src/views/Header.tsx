      ...
      <Navbar expand="lg" bg="dark" variant="dark" style={{ padding: '25px' }} >
        <Container fluid>
          <Navbar.Brand style={{ marginRight: "-30rem" }} href="#">
            <img
              src="https://img.favpng.com/6/15/22/vector-graphics-portable-network-graphics-computer-icons-clip-art-magnifying-glass-png-favpng-uuSX3pTW6uenQcdfUUPDhMESR.jpg"
              alt="Redis Logo"
              style={{
                height: '7%',
                width: '7%',
